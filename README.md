...
· a postgres container. it will be required by the chainlink node anyway, but we use it to our own benefit to store information about the bounties on the site.
